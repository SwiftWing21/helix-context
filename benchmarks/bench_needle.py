...
NEEDLES = [
    ...
    },
    {
        ...
        "query": "What is the binary size of the Rust BigEd build?",
        "expected": "11",
...
def find_needle(client, needle):
    ...
    # Check if the expected answer appears in the expressed context
    found_in_context = needle["expected"].lower() in content.lower()
    ...
    if proxy_resp.status_code == 200:
        ...
        if choices:
            ...
            answer_correct = needle["expected"].lower() in answer_text.lower()
